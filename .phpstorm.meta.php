...
'debugbar.openhandler','debugbar.cache.delete','debugbar.queries.explain','debugbar.clockwork','debugbar.assets','dashboard.index','tickets.index','tickets.create','tickets.store',
'tickets.show','ticket.comment','ticket.comments.update','ticket.comments.destroy','admin.users.index',
'admin.users.create','admin.users.edit','admin.profiles.index','admin.profiles.create','admin.profiles.edit',
'admin.categories.index','admin.categories.create','admin.categories.edit','admin.priorities.index','admin.statuses.index',
'technician.tickets.index','user.tickets.index','supervisor.dashboard','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.categories.create','admin.categories.edit','admin.categories.index','admin.priorities.index','admin.profiles.create',
'admin.profiles.edit','admin.profiles.index','admin.statuses.index','admin.users.create','admin.users.edit',
'admin.users.index','dashboard.index','layouts.app','partials.alert','partials.footer',
'partials.navbar','partials.sidebar','supervisor.dashboard','technician.tickets.index','tickets._form',
'tickets.comments._edit-modal','tickets.create','tickets.index','tickets.show','user.tickets.index',
